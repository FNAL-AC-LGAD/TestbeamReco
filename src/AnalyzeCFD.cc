#define AnalyzeCFD_cxx
#include "TestbeamReco/interface/AnalyzeCFD.h"
...
AnalyzeCFD::AnalyzeCFD()
{
}

//Define all your histograms here. 
void AnalyzeCFD::InitHistos(NTupleReader& tr, const std::vector<std::vector<int>>& geometry)
{
    TH1::SetDefaultSumw2();
    TH2::SetDefaultSumw2();
    ...
    for(const auto& row : geometry)
    {
        ...
        for(unsigned int i = 0; i < row.size(); i++)
        {
            ...
            utility::makeHisto(my_histos,"time"+r+s, "", 500, -425.0, 475.0);
            ...
            utility::makeHisto(my_2d_histos,"timeDiff_30mV_vs_BV_channel"+r+s, "; BV [V]; #Delta t [ps]", bvNbin,bvLow,bvHigh, timeDiffNbin,timeDiffLow,timeDiffHigh);
            ...
            utility::makeHisto(my_2d_histos,"timeDiff_vs_amp"+r+s,           "; amp [mV];    #Delta t [ps]",   450,-50.0,400.0, timeDiffNbin,timeDiffLow,timeDiffHigh);
            utility::makeHisto(my_2d_histos,"timeDiff_vs_charge"+r+s,        "; charge [fC]; #Delta t [ps]",   160,-10.0,150.0, timeDiffNbin,1000*timeDiffLow,1000*timeDiffHigh);
            utility::makeHisto(my_2d_histos,"timeDiff_30mV_vs_amp"+r+s,      "; amp [mV];    #Delta t [ps]",   450,-50.0,400.0, timeDiffNbin,timeDiffLow,timeDiffHigh);
            utility::makeHisto(my_2d_histos,"timeDiff_30mV_vs_charge"+r+s,   "; charge [fC]; #Delta t [ps]",   160,-10.0,150.0, timeDiffNbin,1000*timeDiffLow,1000*timeDiffHigh);
            ...
            utility::makeHisto(my_2d_histos,"efficiency_vs_xy_twoStrip_numerator_channel"+r+s, "; X [mm]; Y [mm]", 2*(xmax-xmin)/xBinSize,xmin,xmax, (ymax-ymin)/yBinSize,ymin,ymax);
    ...
    utility::makeHisto(my_2d_histos,"deltaX_vs_Xtrack_twoStrip", "; X_{track} [mm]; #X_{reco} - X_{track} [mm]", (xmax-xmin)/xBinSize,xmin,xmax, 200,-0.5,0.5);
    utility::makeHisto(my_2d_histos,"deltaX_vs_Xtrack_twoStrip_hotspot", "; X_{track} [mm]; #X_{reco} - X_{track} [mm]", (xmax-xmin)/xBinSize,xmin,xmax, 200,-0.5,0.5);
    ...
    utility::makeHisto(my_2d_histos,"efficiency_vs_xy_twoStrip_numerator", "; X [mm]; Y [mm]", 2*(xmax-xmin)/xBinSize,xmin,xmax, (ymax-ymin)/yBinSize,ymin,ymax);
    ...
    utility::makeHisto(my_2d_histos,"efficiency_vs_xy_twoStrip_numerator_coarseBins", "; X [mm]; Y [mm]", (xmax-xmin)/xBinSize,xmin,xmax, (ymax-ymin)/yBinSize,ymin,ymax);
    ...
    utility::makeHisto(my_1d_prof,"waveProf0", "; Time [ns]; Voltage [mV]", 250,0.0,25.0);
    utility::makeHisto(my_1d_prof,"waveProf1", "; Time [ns]; Voltage [mV]", 250,0.0,25.0);
    utility::makeHisto(my_1d_prof,"waveProf2", "; Time [ns]; Voltage [mV]", 250,0.0,25.0);
    utility::makeHisto(my_1d_prof,"waveProf3", "; Time [ns]; Voltage [mV]", 250,0.0,25.0);
    utility::makeHisto(my_1d_prof,"waveProf4", "; Time [ns]; Voltage [mV]", 250,0.0,25.0);
    utility::makeHisto(my_1d_prof,"waveProf5", "; Time [ns]; Voltage [mV]", 250,0.0,25.0);
    utility::makeHisto(my_1d_prof,"waveProf6", "; Time [ns]; Voltage [mV]", 250,0.0,25.0);
    utility::makeHisto(my_1d_prof,"waveProf7", "; Time [ns]; Voltage [mV]", 250,0.0,25.0);
...
void AnalyzeCFD::Loop(NTupleReader& tr, int maxevents)
{
    ...
    while( tr.getNextEvent() )
    {
        ...
        const auto& timeLGAD_30mV = tr.getVec<std::vector<double>>("timeLGAD_30mV");
        ...
        bool goodTrack = ntracks==1 && nplanes>=14 && npix>=3 && chi2 < 3.0 && xSlope<0.0001 && xSlope>-0.0001;// && ntracks_alt==1;
        ...
        double ampSpy = ampLGAD[0][0];
        bool goodCFDHit = ampLGAD[0][1] > signalAmpThreshold;
        double chargeSpy = (7.0/30.0)*ampSpy;
        ...
        for(const auto& row : ampLGAD)
        {
            for(unsigned int i = 0; i < row.size(); i++)
            {
                ...
                double time_30mV = timeLGAD_30mV[rowIndex][i];
                ...
                utility::fillHisto(pass,                                                    my_histos, "ampMax"+r+s, ampChannel);
                ...
                utility::fillHisto(pass && goodHit,                                         my_histos, "baselineRMS"+r+s, noise);
                utility::fillHisto(pass && goodHit,                                         my_histos, "risetime"+r+s, risetime);
                utility::fillHisto(pass && goodHit,                                         my_histos, "charge"+r+s, charge);
                utility::fillHisto(pass && goodHit,                                         my_histos, "ampChargeRatio"+r+s, ampChargeRatio);
                utility::fillHisto(pass && goodHit,                                         my_histos, "slewRateChargeRatio"+r+s, slewRateChargeRatio); 
                utility::fillHisto(pass && goodHit,                                         my_histos, "slewrate"+r+s, slewrate);
                ...
                utility::fillHisto(pass && goodHit,                                         my_2d_histos, "baselineRMS_vs_x_channel"+r+s, x,noise);
                ...
                utility::fillHisto(pass && goodCFDHit,                                         my_2d_histos, "timeDiff_vs_BV_channel"+r+s, voltage,time-photekTime);
                utility::fillHisto(pass && goodCFDHit,                                         my_2d_histos, "timeDiff_30mV_vs_BV_channel"+r+s, voltage,time_30mV-photekTime);
                utility::fillHisto(pass && goodCFDHit,                                         my_2d_histos, "amp_vs_BV_channel"+r+s, voltage,ampChannel);
                utility::fillHisto(pass && goodCFDHit,                                         my_2d_histos, "risetime_vs_BV_channel"+r+s, voltage,risetime);
                utility::fillHisto(pass && goodCFDHit,                                         my_2d_histos, "baselineRMS_vs_BV_channel"+r+s, voltage,noise);
                utility::fillHisto(pass && goodCFDHit,                                         my_2d_histos, "slewrate_vs_BV_channel"+r+s, voltage,slewrate);
                utility::fillHisto(pass && goodCFDHit,                                         my_2d_histos, "timeDiff_vs_amp"+r+s, ampSpy,time-photekTime);
                utility::fillHisto(pass && goodCFDHit,                                         my_2d_histos, "timeDiff_vs_charge"+r+s, chargeSpy,1000*(time-photekTime));
                utility::fillHisto(pass && goodCFDHit,                                         my_2d_histos, "timeDiff_30mV_vs_amp"+r+s, ampSpy,time_30mV-photekTime);
                utility::fillHisto(pass && goodCFDHit,                                         my_2d_histos, "timeDiff_30mV_vs_charge"+r+s, chargeSpy,1000*(time_30mV-photekTime));

                utility::fillHisto(pass && goodHit && goodNeighbour,                        my_2d_histos, "Amp1OverAmp1and2_vs_deltaXmax_channel"+r+s, deltaXmax, Amp1OverAmp1and2);
                ...
                utility::fillHisto(pass && goodHit,                                         my_2d_histos, "timeDiffTracker_vs_x_channel"+r+s, x,timeTracker-photekTime);
                ...
                utility::fillHisto(pass && goodHit,                                         my_3d_histos, "timeDiffTracker_vs_xy_channel"+r+s, x,y,timeTracker-photekTime);
                utility::fillHisto(pass && goodHit,                                         my_3d_histos, "risetime_vs_xy_channel"+r+s, x,y,risetime);
                utility::fillHisto(pass && goodHit,                                         my_3d_histos, "charge_vs_xy_channel"+r+s, x,y,charge);
                utility::fillHisto(pass && goodHit,                                         my_3d_histos, "ampChargeRatio_vs_xy_channel"+r+s, x,y,ampChargeRatio);

                utility::fillHisto(pass && goodNoiseAmp,                                    my_2d_histos, "efficiency_vs_xy_numerator_channel"+r+s, x,y);
                utility::fillHisto(pass && goodNoiseAmp && !goodNeighbour,                  my_2d_histos, "efficiency_vs_xy_noNeighb_numerator_channel"+r+s, x,y);
                utility::fillHisto(pass && goodNoiseAmp && highFraction,                    my_2d_histos, "efficiency_vs_xy_highFrac_numerator_channel"+r+s, x,y);
                utility::fillHisto(pass && goodNoiseAmp && oneStripReco,                    my_2d_histos, "efficiency_vs_xy_oneStrip_numerator_channel"+r+s, x,y);
                utility::fillHisto(pass && goodNoiseAmp && twoStripReco,                   my_2d_histos, "efficiency_vs_xy_twoStrip_numerator_channel"+r+s, x,y);
                ...
                utility::fillHisto(goodTrack && goodPhotek,                                 my_2d_prof, "efficiency_vs_xy_prof", x,y,goodHit);
                utility::fillHisto(pass,                                                    my_2d_prof, "efficiency_vs_xy_EdgeCut_prof",   x,y,goodHit);
                utility::fillHisto(goodTrack && goodPhotek && !goodNeighbour,               my_2d_prof, "efficiency_vs_xy_noNeighb_prof",  x,y,goodHit);
                utility::fillHisto(goodTrack && goodPhotek && highFraction,                 my_2d_prof, "efficiency_vs_xy_highFrac_prof",  x,y,goodHit);
                utility::fillHisto(goodTrack && goodPhotek && oneStripReco,                 my_2d_prof, "efficiency_vs_xy_oneStrip_prof",  x,y,goodHit);
                utility::fillHisto(goodTrack && goodPhotek && twoStripReco,                my_2d_prof, "efficiency_vs_xy_twoStrip_prof", x,y,goodHit);
        ...
        utility::fillHisto(pass && maxAmpNotEdgeStrip && goodMaxLGADAmp && twoStripReco,                  my_histos, "deltaX_twoStrip", x_reco-x);
        utility::fillHisto(pass && maxAmpNotEdgeStrip && goodMaxLGADAmp && twoStripReco && !hitOnMetal,   my_histos, "deltaX_twoStrip_Gap", x_reco-x);
        ...
        utility::fillHisto(pass && maxAmpNotEdgeStrip && goodMaxLGADAmp && twoStripReco && twoGoodChannel,my_histos, "deltaY_twoStrip", y_reco-y);
        ...
        utility::fillHisto(pass && maxAmpNotEdgeStrip && goodMaxLGADAmp && twoStripReco,                  my_histos, "weighted_timeDiff_LGADXY_2Strip", weighted_time_LGADXY-photekTime);
        utility::fillHisto(pass && maxAmpNotEdgeStrip && goodMaxLGADAmp && twoStripReco,                  my_histos, "weighted_timeDiff_LGADX_2Strip", weighted_time_LGADX-photekTime);
        utility::fillHisto(pass && maxAmpNotEdgeStrip && goodMaxLGADAmp && twoStripReco,                  my_histos, "weighted2_timeDiff_LGADXY_2Strip", weighted2_time_LGADXY-photekTime);
        utility::fillHisto(pass && maxAmpNotEdgeStrip && goodMaxLGADAmp && twoStripReco,                  my_histos, "weighted2_timeDiff_LGADX_2Strip", weighted2_time_LGADX-photekTime);
        utility::fillHisto(pass && maxAmpNotEdgeStrip && goodMaxLGADAmp && twoStripReco,                  my_histos, "average_timeDiff_LGADXY_2Strip", average_time_LGADXY-photekTime);
        utility::fillHisto(pass && maxAmpNotEdgeStrip && goodMaxLGADAmp && twoStripReco,                  my_histos, "average_timeDiff_LGADX_2Strip", average_time_LGADX-photekTime);
        ...
        utility::fillHisto(pass,                                                     my_2d_histos, "Amp1OverAmp123_vs_deltaXmax", fabs(deltaXmax),Amp1OverAmp123);
        utility::fillHisto(pass,                                                     my_2d_histos, "Xtrack_vs_Amp1OverAmp123", x,Amp1OverAmp123);
        utility::fillHisto(pass,                                                     my_2d_histos, "Xtrack_vs_Amp2OverAmp123", x,Amp2OverAmp123);
        utility::fillHisto(pass,                                                     my_2d_histos, "Xtrack_vs_Amp3OverAmp123", x,Amp3OverAmp123);
        utility::fillHisto(pass && goodMaxLGADAmp,                                   my_2d_histos, "deltaX_vs_Xtrack", x,x_reco-x);
        utility::fillHisto(pass && goodMaxLGADAmp,                                   my_2d_histos, "deltaXBasic_vs_Xtrack", x,x_reco_basic-x);
        utility::fillHisto(pass && goodMaxLGADAmp,                                   my_2d_histos, "deltaYBasic_vs_Xtrack", x,y_reco_basic-y);
        utility::fillHisto(pass && goodMaxLGADAmp,                                   my_2d_histos, "deltaYBasic_vs_Ytrack", y,y_reco_basic-y);

        utility::fillHisto(pass && goodOverNoiseAmp && !goodNeighbour,                                     my_2d_histos, "deltaX_vs_Xtrack_noNeighb", x,x_reco-x);
        utility::fillHisto(pass && goodOverNoiseAmp && highFraction,                                       my_2d_histos, "deltaX_vs_Xtrack_highFrac", x,x_reco-x);
        utility::fillHisto(pass && goodOverNoiseAmp && oneStripReco,                                       my_2d_histos, "deltaX_vs_Xtrack_oneStrip", x,x_reco-x);
        utility::fillHisto(pass && goodMaxLGADAmp && twoStripReco,                                        my_2d_histos, "deltaX_vs_Xtrack_twoStrip", x,x_reco-x);
        utility::fillHisto(pass && goodMaxLGADAmp && twoStripReco,                                        my_2d_histos, "Amp12_vs_x", x, Amp12);
        utility::fillHisto(pass && goodMaxLGADAmp && twoStripReco,                                        my_2d_histos, "Amp1_vs_x", x, maxAmp);
        utility::fillHisto(pass && goodMaxLGADAmp && twoStripReco,                                        my_2d_histos, "Amp2_vs_x", x, amp2);
        utility::fillHisto(pass && goodMaxLGADAmp && twoStripReco,                                        my_2d_histos, "BaselineRMS12_vs_x", x, Noise12);
        utility::fillHisto(pass && goodMaxLGADAmp && twoStripReco,                                        my_2d_histos, "dXdFrac_vs_Xtrack", x,dXdFrac);

        utility::fillHisto(pass && goodMaxLGADAmp,                                   my_2d_histos, "deltaX_vs_Xreco", x_reco,x_reco-x);
        utility::fillHisto(pass && goodMaxLGADAmp && twoStripReco  && twoGoodChannel,my_2d_histos, "deltaY_vs_Xtrack", x,y_reco-y);
        utility::fillHisto(pass && goodMaxLGADAmp && twoStripReco  && twoGoodChannel,my_2d_histos, "deltaY_vs_Ytrack", y,y_reco-y);
        utility::fillHisto(pass && goodMaxLGADAmp && twoStripReco  && twoGoodChannel,my_2d_histos, "deltaY_vs_Ytrack_1cm", y,y_reco-y);
        utility::fillHisto(pass && goodMaxLGADAmp && twoStripReco,                  my_histos, "y", y);
        utility::fillHisto(pass && goodMaxLGADAmp && twoStripReco,                  my_histos, "y_reco", y_reco);
        utility::fillHisto(pass && goodMaxLGADAmp && twoStripReco,                  my_histos, "ratioe", y/y_reco);
        utility::fillHisto(pass && goodMaxLGADAmp && twoStripReco  && twoGoodChannel,my_2d_histos, "deltaY_vs_Yreco", y_reco,y_reco-y);
        utility::fillHisto(pass && goodMaxLGADAmp,                                   my_2d_histos, "deltaXmax_vs_Xtrack", x,deltaXmax);
        utility::fillHisto(pass && goodMaxLGADAmp,                                   my_2d_histos, "deltaXmax_vs_Xreco", x_reco,deltaXmax);
        utility::fillHisto(pass && goodMaxLGADAmp,                                   my_2d_histos, "weighted_timeDiff_vs_x", x,weighted_time-photekTime);
        utility::fillHisto(pass && goodMaxLGADAmp,                                   my_2d_histos, "weighted_timeDiff_tracker_vs_x", x,weighted_time_tracker-photekTime);
        utility::fillHisto(pass && goodMaxLGADAmp,                                   my_2d_histos, "Xreco_vs_Xtrack", x,x_reco);
        utility::fillHisto(pass && goodMaxLGADAmp && twoStripReco,                  my_2d_histos, "Yreco_vs_Ytrack", y,y_reco);
        ...
        utility::fillHisto(pass && goodMaxLGADAmp,                                   my_3d_histos, "timeDiffLGADXTrackerY_vs_xy", x,y,maxAmpTimeLGADXTrackerY-photekTime);
        utility::fillHisto(pass && goodMaxLGADAmp,                                   my_3d_histos, "timeDiffLGADXY_vs_xy", x,y,maxAmpTimeLGADXY-photekTime);
        utility::fillHisto(pass && goodMaxLGADAmp,                                   my_3d_histos, "timeDiffLGADXY0_vs_xy", x,y,maxAmpTimeLGADXY0-photekTime);
        utility::fillHisto(pass && goodMaxLGADAmp,                                   my_3d_histos, "timeDiffLGADX_vs_xy", x,y,maxAmpTimeLGADX-photekTime);        
        utility::fillHisto(pass && goodMaxLGADAmp,                                   my_3d_histos, "timeDiffTrackerX_vs_xy", x,y,maxAmpTimeTrackerX-photekTime);
        utility::fillHisto(pass && goodMaxLGADAmp,                                   my_3d_histos, "timeDiff_vs_xy_amp2", x,y,amp2Time-photekTime);
        utility::fillHisto(pass && goodMaxLGADAmp,                                   my_3d_histos, "timeDiff_vs_xy_amp3", x,y,amp3Time-photekTime);
        utility::fillHisto(pass && goodMaxLGADAmp,                                   my_3d_histos, "weighted_timeDiff_vs_xy", x,y,weighted_time-photekTime);
        utility::fillHisto(pass && goodMaxLGADAmp,                                   my_3d_histos, "weighted_timeDiff_tracker_vs_xy", x,y,weighted_time_tracker-photekTime);
        utility::fillHisto(pass && goodMaxLGADAmp,                                   my_3d_histos, "weighted2_timeDiff_vs_xy", x,y,weighted2_time-photekTime);
        ...
        utility::fillHisto(pass && goodMaxLGADAmp,                                   my_3d_histos, "weighted_timeDiff_LGADXY_vs_xy", x,y,weighted_time_LGADXY-photekTime);
        utility::fillHisto(pass && goodMaxLGADAmp,                                   my_3d_histos, "weighted2_timeDiff_LGADXY_vs_xy", x,y,weighted2_time_LGADXY-photekTime);
        utility::fillHisto(pass && goodMaxLGADAmp,                                   my_3d_histos, "weighted_timeDiff_LGADX_vs_xy", x,y,weighted_time_LGADX-photekTime);
        utility::fillHisto(pass && goodMaxLGADAmp,                                   my_3d_histos, "weighted2_timeDiff_LGADX_vs_xy", x,y,weighted2_time_LGADX-photekTime);
        utility::fillHisto(pass && goodMaxLGADAmp,                                   my_3d_histos, "weighted_timeDiff_TrackerX_vs_xy", x,y,weighted_time_trackerX-photekTime);
        utility::fillHisto(pass && goodMaxLGADAmp,                                   my_3d_histos, "weighted2_timeDiff_TrackerX_vs_xy", x,y,weighted2_time_trackerX-photekTime);
        utility::fillHisto(pass && goodMaxLGADAmp,                                   my_3d_histos, "average_timeDiff_LGADXY_vs_xy", x,y,average_time_LGADXY-photekTime);
        utility::fillHisto(pass && goodMaxLGADAmp,                                   my_3d_histos, "average_timeDiff_LGADX_vs_xy", x,y,average_time_LGADX-photekTime);
        utility::fillHisto(pass && goodMaxLGADAmp,                                   my_3d_histos, "weighted_timeDiff_goodSig_vs_xy", x,y,weighted_time_goodSig-photekTime);
        utility::fillHisto(pass && goodMaxLGADAmp,                                   my_3d_histos, "weighted2_timeDiff_goodSig_vs_xy", x,y,weighted2_time_goodSig-photekTime);
        utility::fillHisto(pass && goodMaxLGADAmp,                                   my_3d_histos, "deltaX_vs_Xtrack_vs_Ytrack", x,y,x_reco-x);
        utility::fillHisto(pass && goodMaxLGADAmp && twoStripReco  && twoGoodChannel,my_3d_histos, "deltaY_vs_Xtrack_vs_Ytrack", x,y,y_reco-y);

        // Save profiles and efficiency histos using pass, i.e. tight edges cut
        utility::fillHisto(pass,                                                     my_1d_prof, "Xtrack_vs_Amp1OverAmp123_prof", x,Amp1OverAmp123);
        utility::fillHisto(pass,                                                     my_1d_prof, "Xtrack_vs_Amp2OverAmp123_prof", x,Amp2OverAmp123);
        utility::fillHisto(pass,                                                     my_1d_prof, "Xtrack_vs_Amp3OverAmp123_prof", x,Amp3OverAmp123);
        utility::fillHisto(pass && goodMaxLGADAmp,                                   my_1d_prof, "clusterSize_vs_x_prof", x,clusterSize);
        ...
        utility::fillHisto(pass && hasGlobalSignal_lowThreshold && twoStripReco,                          my_2d_histos, "efficiency_vs_xy_twoStrip_numerator", x,y);
        ...
        utility::fillHisto(pass && hasGlobalSignal_lowThreshold && twoStripReco,                          my_2d_histos, "efficiency_vs_xy_twoStrip_numerator_coarseBins", x,y);
        ...
        if(plotWaveForm && corrAmp[0] > 94.0 &&  corrAmp[0] < 96.0)
        {
            std::cout<<corrAmp[0]<<std::endl;
            const auto& channel = tr.getVecVec<float>("channel");
...
void AnalyzeCFD::WriteHistos(TFile* outfile)
{
    outfile->cd();
