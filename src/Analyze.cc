...
void Analyze::InitHistos(NTupleReader& tr, const std::vector<std::vector<int>>& geometry)
{
    ...
    my_2d_histos.emplace( "Amp1OverAmp1andTopPad1_vs_deltaXmax", std::make_shared<TH2D>( "Amp1OverAmp1andTopPad1_vs_deltaXmax", "Amp1OverAmp1andTopPad1_vs_deltaXmax; #X_{track} - X_{Max Strip} [mm]; Amp_{Max} / (Amp_{Max} + Amp_{Top})", 0.50/0.002,-0.25,0.25, 100,0.0,1.0 ) );
    my_2d_histos.emplace( "Amp1OverAmp1andTopPad2_vs_deltaXmax", std::make_shared<TH2D>( "Amp1OverAmp1andTopPad2_vs_deltaXmax", "Amp1OverAmp1andTopPad2_vs_deltaXmax; #X_{track} - X_{Max Strip} [mm]; Amp_{Max} / (Amp_{Max} + Amp_{Top})", 0.50/0.002,-0.25,0.25, 100,0.0,1.0 ) );
    my_2d_histos.emplace( "Amp1OverAmp1andBotPad3_vs_deltaXmax", std::make_shared<TH2D>( "Amp1OverAmp1andBotPad3_vs_deltaXmax", "Amp1OverAmp1andBotPad3_vs_deltaXmax; #X_{track} - X_{Max Strip} [mm]; Amp_{Max} / (Amp_{Max} + Amp_{Bot})", 0.50/0.002,-0.25,0.25, 100,0.0,1.0 ) );
...
void Analyze::Loop(NTupleReader& tr, int maxevents)
{
	...
	//******************************************************************        
        ...
        utility::fillHisto(pass && maxAmpinPad1,                         my_2d_histos["Amp1OverAmp1andTopPad1_vs_deltaXmax"], fabs(deltaXmax),Amp1OverAmp1andTop);
        utility::fillHisto(pass && maxAmpinPad2,                         my_2d_histos["Amp1OverAmp1andTopPad2_vs_deltaXmax"], fabs(deltaXmax),Amp1OverAmp1andTop);
        utility::fillHisto(pass && maxAmpinPad3,                         my_2d_histos["Amp1OverAmp1andBotPad3_vs_deltaXmax"], fabs(deltaXmax),Amp1OverAmp1andBot);     
        utility::fillHisto(pass && maxAmpinPad4,                         my_2d_histos["Amp1OverAmp1andBotPad4_vs_deltaXmax"], fabs(deltaXmax),Amp1OverAmp1andBot);    
