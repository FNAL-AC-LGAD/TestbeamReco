...
void Analyze::InitHistos(NTupleReader& tr, const std::vector<std::vector<int>>& geometry)
{
    ...
    for(const auto& row : geometry)
    {
        ...
        for(unsigned int i = 0; i < row.size(); i++)
        {
            ...
            utility::makeHisto(my_2d_histos,"efficiency_vs_xy_twoStrips_numerator_channel"+r+s, "; X [mm]; Y [mm]", 2*std::round((xmax-xmin)/xBinSize),xmin,xmax, std::round((ymax-ymin)/yBinSize),ymin,ymax);
            ...
            utility::makeHisto(my_2d_histos,"efficiency_vs_xy_twoStrips_numerator_tight_channel"+r+s, "; X [mm]; Y [mm]", 2*std::round((xmax-xmin)/xBinSize),xmin,xmax, std::round((ymax-ymin)/yBinSize),ymin,ymax);
    ...
    utility::makeHisto(my_histos,"deltaX_twoStrips_Metal", "; X_{reco} - X_{track} [mm]; Events", 200,-0.5,0.5);
    ...
    utility::makeHisto(my_histos,"deltaX_twoStrips_Metal_tight", "; X_{reco} - X_{track} [mm]; Events", 200,-0.5,0.5);
    ...
    utility::makeHisto(my_histos,"deltaX_twoStrips_Gap_tight", "; X_{reco} - X_{track} [mm]; Events", 200,-0.5,0.5);
    ...
    utility::makeHisto(my_2d_histos,"deltaX_vs_Xtrack_twoStrips_hotspot", "; X_{track} [mm]; #X_{reco} - X_{track} [mm]", std::round((xmax-xmin)/xBinSize),xmin,xmax, 200,-0.5,0.5);
    ...
    utility::makeHisto(my_2d_histos,"deltaX_vs_Xtrack_twoStrips_tight", "; X_{track} [mm]; #X_{reco} - X_{track} [mm]", std::round((xmax-xmin)/xBinSize),xmin,xmax, 200,-0.5,0.5);
    ...
    utility::makeHisto(my_2d_histos,"efficiency_vs_xy_twoStrips_numerator", "; X [mm]; Y [mm]", 2*std::round((xmax-xmin)/xBinSize),xmin,xmax, std::round((ymax-ymin)/yBinSize),ymin,ymax);
    ...
    utility::makeHisto(my_2d_histos,"efficiency_vs_xy_twoStrips_numerator_coarseBins", "; X [mm]; Y [mm]", std::round((xmax-xmin)/xBinSize),xmin,xmax, std::round((ymax-ymin)/yBinSize),ymin,ymax);
    ...
    utility::makeHisto(my_2d_histos,"efficiency_vs_xy_twoStrips_numerator_tight", "; X [mm]; Y [mm]", 2*std::round((xmax-xmin)/xBinSize),xmin,xmax, std::round((ymax-ymin)/yBinSize),ymin,ymax);
    ...
    utility::makeHisto(my_2d_histos,"efficiency_vs_xy_twoStrips_numerator_coarseBins_tight", "; X [mm]; Y [mm]", std::round((xmax-xmin)/xBinSize),xmin,xmax, std::round((ymax-ymin)/yBinSize),ymin,ymax);
...
void Analyze::Loop(NTupleReader& tr, int maxevents)
{
    ...
    while( tr.getNextEvent() )
    {
        ...
        const auto& twoStripsReco = tr.getVar<bool>("twoStripsReco");
        ...
        for(const auto& row : ampLGAD)
        {
            for(unsigned int i = 0; i < row.size(); i++)
            {
                ...
                */
                ...
                utility::fillHisto(pass_NoXYEdges_NoPhotek && goodNoiseAmp && twoStripsReco && isMaxChannel,   my_2d_histos, "efficiency_vs_xy_twoStrips_numerator_tight_channel"+r+s, x,y);
        ...
        utility::fillHisto(pass && goodAmpColHit && twoStripsReco,                      my_histos, "deltaX_twoStrips", x_reco-x);
        ...
        utility::fillHisto(pass_tight && goodAmpColHit && twoStripsReco,                my_histos, "deltaX_twoStrips_tight", x_reco-x);
        ...
        utility::fillHisto(pass && goodAmpColHit && twoStripsReco && hitOnMetal,        my_histos, "deltaX_twoStrips_Metal", x_reco-x);
        ...
        utility::fillHisto(pass_tight && goodAmpColHit && twoStripsReco && hitOnMetal,  my_histos, "deltaX_twoStrips_Metal_tight", x_reco-x);
        ...
        utility::fillHisto(pass && goodAmpColHit && twoStripsReco && !hitOnMetal,       my_histos, "deltaX_twoStrips_Gap", x_reco-x);
        ...
        utility::fillHisto(pass_tight && goodAmpColHit && twoStripsReco && !hitOnMetal, my_histos, "deltaX_twoStrips_Gap_tight", x_reco-x);
        ...
        utility::fillHisto(pass && goodAmpHit && twoStripsReco && twoGoodChannel,       my_histos, "deltaY_twoStrips", y_reco-y);
        ...
        utility::fillHisto(pass && goodAmpColHit && twoStripsReco,  my_histos, "weighted_timeDiff_LGADXY_2Strip", weighted_time_LGADXY-photekTime);
        utility::fillHisto(pass && goodAmpColHit && twoStripsReco,  my_histos, "weighted_timeDiff_LGADX_2Strip", weighted_time_LGADX-photekTime);
        utility::fillHisto(pass && goodAmpColHit && twoStripsReco,  my_histos, "weighted2_timeDiff_LGADXY_2Strip", weighted2_time_LGADXY-photekTime);
        utility::fillHisto(pass && goodAmpColHit && twoStripsReco,  my_histos, "weighted2_timeDiff_LGADX_2Strip", weighted2_time_LGADX-photekTime);
        utility::fillHisto(pass && goodAmpColHit && twoStripsReco,  my_histos, "average_timeDiff_LGADXY_2Strip", average_time_LGADXY-photekTime);
        utility::fillHisto(pass && goodAmpColHit && twoStripsReco,  my_histos, "average_timeDiff_LGADX_2Strip", average_time_LGADX-photekTime);
        ...
        for(unsigned int k = 0; k < regionsOfIntrest.size(); k++)
        {
            if(regionsOfIntrest[k].passROI(x,y))
            {
                ...
                {
                    utility::fillHisto(pass && goodAmpColHit && twoStripsReco,  my_2d_histos, "deltaX_vs_Xtrack_twoStrips_hotspot", x,x_reco-x);
        ...
        utility::fillHisto(pass && goodAmpColHit && twoStripsReco,                      my_2d_histos, "deltaX_vs_Xtrack_twoStrips", x,x_reco-x);
        utility::fillHisto(pass && goodAmpColHit && twoStripsReco,                      my_2d_histos, "Amp12_vs_x", x, Amp12);
        utility::fillHisto(pass && goodAmpColHit && twoStripsReco,                      my_2d_histos, "Amp1_vs_x", x, ampColLGAD1st);
        utility::fillHisto(pass && goodAmpColHit && twoStripsReco,                      my_2d_histos, "Amp2_vs_x", x, ampColLGAD2nd);
        utility::fillHisto(pass && goodAmpColHit && twoStripsReco,                      my_2d_histos, "BaselineRMS12_vs_x", x, Noise12);
        utility::fillHisto(pass && goodAmpColHit && twoStripsReco,                      my_2d_histos, "dXdFrac_vs_Xtrack", x,dXdFrac);


        utility::fillHisto(pass_NoXYEdges && goodAmpColHit && twoStripsReco,            my_2d_histos, "deltaX_vs_Xtrack_twoStrips_tight", x,x_reco-x);
        utility::fillHisto(pass_NoXYEdges && goodAmpColHit && twoStripsReco,            my_2d_histos, "Amp12_vs_x_tight", x, Amp12);
        utility::fillHisto(pass_NoXYEdges && goodAmpColHit && twoStripsReco,            my_2d_histos, "Amp1_vs_x_tight", x, ampColLGAD1st);
        utility::fillHisto(pass_NoXYEdges && goodAmpColHit && twoStripsReco,            my_2d_histos, "Amp2_vs_x_tight", x, ampColLGAD2nd);
        utility::fillHisto(pass_NoXYEdges && goodAmpColHit && twoStripsReco,            my_2d_histos, "BaselineRMS12_vs_x_tight", x, Noise12);
        utility::fillHisto(pass_NoXYEdges && goodAmpColHit && twoStripsReco,            my_2d_histos, "dXdFrac_vs_Xtrack_tight", x,dXdFrac);


        utility::fillHisto(pass && goodAmpColHit,                                       my_2d_histos, "deltaX_vs_Xreco", x_reco,x_reco-x);
        utility::fillHisto(pass && goodAmpHit && twoStripsReco  && twoGoodChannel,      my_2d_histos, "deltaY_vs_Xtrack", x,y_reco-y);
        utility::fillHisto(pass && goodAmpHit && twoStripsReco  && twoGoodChannel,      my_2d_histos, "deltaY_vs_Ytrack", y,y_reco-y);
        utility::fillHisto(pass && goodAmpHit && twoStripsReco  && twoGoodChannel,      my_2d_histos, "deltaY_vs_Ytrack_1cm", y,y_reco-y);
        utility::fillHisto(pass && goodAmpHit && twoStripsReco,                         my_histos, "y", y);
        utility::fillHisto(pass && goodAmpHit && twoStripsReco,                         my_histos, "y_reco", y_reco);
        utility::fillHisto(pass && goodAmpHit && twoStripsReco,                         my_histos, "ratioe", y/y_reco);
        utility::fillHisto(pass && goodAmpHit && twoStripsReco  && twoGoodChannel,      my_2d_histos, "deltaY_vs_Yreco", y_reco,y_reco-y);
        ...
        utility::fillHisto(pass && goodAmpHit && twoStripsReco,                         my_2d_histos, "Yreco_vs_Ytrack", y,y_reco);
        ...
        utility::fillHisto(pass && goodAmpColHit && twoStripsReco,                  my_3d_histos, "timeDiffLGADXTrackerY_vs_xy_2Strip", x,y,maxAmpTimeLGADXTrackerY-photekTime);
        utility::fillHisto(pass && goodAmpColHit && twoStripsReco,                  my_3d_histos, "timeDiffLGADXY_vs_xy_2Strip", x,y,maxAmpTimeLGADXY-photekTime);
        utility::fillHisto(pass && goodAmpColHit && twoStripsReco,                  my_3d_histos, "timeDiffLGADXY0_vs_xy_2Strip", x,y,maxAmpTimeLGADXY0-photekTime);
        utility::fillHisto(pass && goodAmpColHit && twoStripsReco,                  my_3d_histos, "timeDiffLGADX_vs_xy_2Strip", x,y,maxAmpTimeLGADX-photekTime);
        utility::fillHisto(pass && goodAmpColHit && twoStripsReco,                  my_3d_histos, "timeDiffTrackerX_vs_xy_2Strip", x,y,maxAmpTimeTrackerX-photekTime);

        utility::fillHisto(pass && goodAmpColHit && OddChannel && twoStripsReco,    my_3d_histos, "timeDiffLGADXTrackerY_vs_xy_2Strip_Odd", x,y,maxAmpTimeLGADXTrackerY-photekTime);
        utility::fillHisto(pass && goodAmpColHit && OddChannel && twoStripsReco,    my_3d_histos, "timeDiffLGADXY_vs_xy_2Strip_Odd", x,y,maxAmpTimeLGADXY-photekTime);
        utility::fillHisto(pass && goodAmpColHit && OddChannel && twoStripsReco,    my_3d_histos, "timeDiffLGADXY0_vs_xy_2Strip_Odd", x,y,maxAmpTimeLGADXY0-photekTime);
        utility::fillHisto(pass && goodAmpColHit && OddChannel && twoStripsReco,    my_3d_histos, "timeDiffLGADX_vs_xy_2Strip_Odd", x,y,maxAmpTimeLGADX-photekTime);
        utility::fillHisto(pass && goodAmpColHit && OddChannel && twoStripsReco,    my_3d_histos, "timeDiffTrackerX_vs_xy_2Strip_Odd", x,y,maxAmpTimeTrackerX-photekTime);

        utility::fillHisto(pass && goodAmpColHit && EvenChannel && twoStripsReco,   my_3d_histos, "timeDiffLGADXTrackerY_vs_xy_2Strip_Even", x,y,maxAmpTimeLGADXTrackerY-photekTime);
        utility::fillHisto(pass && goodAmpColHit && EvenChannel && twoStripsReco,   my_3d_histos, "timeDiffLGADXY_vs_xy_2Strip_Even", x,y,maxAmpTimeLGADXY-photekTime);
        utility::fillHisto(pass && goodAmpColHit && EvenChannel && twoStripsReco,   my_3d_histos, "timeDiffLGADXY0_vs_xy_2Strip_Even", x,y,maxAmpTimeLGADXY0-photekTime);
        utility::fillHisto(pass && goodAmpColHit && EvenChannel && twoStripsReco,   my_3d_histos, "timeDiffLGADX_vs_xy_2Strip_Even", x,y,maxAmpTimeLGADX-photekTime);
        utility::fillHisto(pass && goodAmpColHit && EvenChannel && twoStripsReco,   my_3d_histos, "timeDiffTrackerX_vs_xy_2Strip_Even", x,y,maxAmpTimeTrackerX-photekTime);
        ...
        utility::fillHisto(pass && goodAmpColHit && twoStripsReco,                  my_3d_histos, "weighted_timeDiff_LGADXY_vs_xy_2Strip", x,y,weighted_time_LGADXY-photekTime);
        utility::fillHisto(pass && goodAmpColHit && twoStripsReco,                  my_3d_histos, "weighted2_timeDiff_LGADXY_vs_xy_2Strip", x,y,weighted2_time_LGADXY-photekTime);
        utility::fillHisto(pass && goodAmpColHit && twoStripsReco,                  my_3d_histos, "weighted_timeDiff_LGADX_vs_xy_2Strip", x,y,weighted_time_LGADX-photekTime);
        utility::fillHisto(pass && goodAmpColHit && twoStripsReco,                  my_3d_histos, "weighted2_timeDiff_LGADX_vs_xy_2Strip", x,y,weighted2_time_LGADX-photekTime);
        utility::fillHisto(pass && goodAmpColHit && twoStripsReco,                  my_3d_histos, "average_timeDiff_LGADXY_vs_xy_2Strip", x,y,average_time_LGADXY-photekTime);
        utility::fillHisto(pass && goodAmpColHit && twoStripsReco,                  my_3d_histos, "average_timeDiff_LGADX_vs_xy_2Strip", x,y,average_time_LGADX-photekTime);

        utility::fillHisto(pass && goodAmpColHit && twoStripsReco && OddChannel,    my_3d_histos, "weighted_timeDiff_LGADXY_vs_xy_2Strip_Odd", x,y,weighted_time_LGADXY-photekTime);
        utility::fillHisto(pass && goodAmpColHit && twoStripsReco && OddChannel,    my_3d_histos, "weighted2_timeDiff_LGADXY_vs_xy_2Strip_Odd", x,y,weighted2_time_LGADXY-photekTime);
        utility::fillHisto(pass && goodAmpColHit && twoStripsReco && OddChannel,    my_3d_histos, "weighted_timeDiff_LGADX_vs_xy_2Strip_Odd", x,y,weighted_time_LGADX-photekTime);
        utility::fillHisto(pass && goodAmpColHit && twoStripsReco && OddChannel,    my_3d_histos, "weighted2_timeDiff_LGADX_vs_xy_2Strip_Odd", x,y,weighted2_time_LGADX-photekTime);
        utility::fillHisto(pass && goodAmpColHit && twoStripsReco && OddChannel,    my_3d_histos, "average_timeDiff_LGADXY_vs_xy_2Strip_Odd", x,y,average_time_LGADXY-photekTime);
        utility::fillHisto(pass && goodAmpColHit && twoStripsReco && OddChannel,    my_3d_histos, "average_timeDiff_LGADX_vs_xy_2Strip_Odd", x,y,average_time_LGADX-photekTime);

        utility::fillHisto(pass && goodAmpColHit && twoStripsReco && EvenChannel,   my_3d_histos, "weighted_timeDiff_LGADXY_vs_xy_2Strip_Even", x,y,weighted_time_LGADXY-photekTime);
        utility::fillHisto(pass && goodAmpColHit && twoStripsReco && EvenChannel,   my_3d_histos, "weighted2_timeDiff_LGADXY_vs_xy_2Strip_Even", x,y,weighted2_time_LGADXY-photekTime);
        utility::fillHisto(pass && goodAmpColHit && twoStripsReco && EvenChannel,   my_3d_histos, "weighted_timeDiff_LGADX_vs_xy_2Strip_Even", x,y,weighted_time_LGADX-photekTime);
        utility::fillHisto(pass && goodAmpColHit && twoStripsReco && EvenChannel,   my_3d_histos, "weighted2_timeDiff_LGADX_vs_xy_2Strip_Even", x,y,weighted2_time_LGADX-photekTime);
        utility::fillHisto(pass && goodAmpColHit && twoStripsReco && EvenChannel,   my_3d_histos, "average_timeDiff_LGADXY_vs_xy_2Strip_Even", x,y,average_time_LGADXY-photekTime);
        utility::fillHisto(pass && goodAmpColHit && twoStripsReco && EvenChannel,   my_3d_histos, "average_timeDiff_LGADX_vs_xy_2Strip_Even", x,y,average_time_LGADX-photekTime);
        ...
        utility::fillHisto(pass && goodAmpColHit && twoStripsReco  && twoGoodChannel,my_3d_histos, "deltaY_vs_Xtrack_vs_Ytrack", x,y,y_reco-y);
        ...
        utility::fillHisto(pass && goodOverNoiseAmpCol && twoStripsReco,            my_2d_histos, "efficiency_vs_xy_twoStrips_numerator", x,y);
        utility::fillHisto(pass && fullReco,                                        my_2d_histos, "efficiency_vs_xy_fullReco_numerator", x,y);

        // TEST: No Sum
        utility::fillHisto(pass && goodOverNoiseAmpCol && hitOnMetal,                   my_2d_histos, "efficiency_vs_xy_NoSum_numerator", x,y);
        utility::fillHisto(pass && goodOverNoiseAmpCol && hitOnMetal && oneStripReco,   my_2d_histos, "efficiency_vs_xy_NoSum_oneStrip_numerator", x,y);
        utility::fillHisto(pass && goodOverNoiseAmpCol && hitOnMetal && twoStripsReco,  my_2d_histos, "efficiency_vs_xy_NoSum_twoStrip_numerator", x,y);
        ...
        utility::fillHisto(pass && goodOverNoiseAmpCol && hitOnMetal && twoStripsReco,  my_2d_histos, "efficiency_vs_xy_Metal_twoStrip_numerator", x,y);
        ...
        utility::fillHisto(pass && goodOverNoiseAmpCol && !hitOnMetal && twoStripsReco, my_2d_histos, "efficiency_vs_xy_Gap_twoStrip_numerator", x,y);
        ...
        utility::fillHisto(pass && goodOverNoiseAmpCol && hitOnMidGap && twoStripsReco, my_2d_histos, "efficiency_vs_xy_MidGap_twoStrip_numerator", x,y);
        ...
        utility::fillHisto(pass && goodOverNoiseAmpCol && twoStripsReco,                my_2d_histos, "efficiency_vs_xy_twoStrips_numerator_coarseBins", x,y);
        ...
        utility::fillHisto(pass_NoXYEdges_NoPhotek && goodOverNoiseAmpCol && twoStripsReco,     my_2d_histos, "efficiency_vs_xy_twoStrips_numerator_tight", x,y);
        ...
        utility::fillHisto(pass_NoXYEdges_NoPhotek && goodOverNoiseAmpCol && twoStripsReco,     my_2d_histos, "efficiency_vs_xy_twoStrips_numerator_coarseBins_tight", x,y);
        ...
        my_efficiencies["event_twoStripsReco"]->FillWeighted(pass && goodOverNoiseAmpCol,1.0,1); // "Signal over highThreshold");
        my_efficiencies["event_twoStripsReco"]->FillWeighted(pass && goodOverNoiseAmpCol && goodNeighbour,1.0,2); // "Good neighbour");
        my_efficiencies["event_twoStripsReco"]->FillWeighted(pass && goodOverNoiseAmpCol && !highFraction,1.0,3); // "Good Amp fraction");
        my_efficiencies["event_twoStripsReco"]->FillWeighted(pass && goodOverNoiseAmpCol && twoStripsReco,1.0,4); // "TwoStripsReco");
        my_efficiencies["event_twoStripsReco"]->FillWeighted(pass && goodOverNoiseAmpCol && twoStripsReco && hitOnMetal,1.0,5); // "TwoStripsReco && OnMetal");
        ...
        my_efficiencies["event_Overall"]->FillWeighted(pass && maxAmpNotEdgeStrip && goodOverNoiseAmpCol && twoStripsReco,1.0,4); // "TwoStripsReco");
        ...
        my_efficiencies["event_Metal"]->FillWeighted(pass && maxAmpNotEdgeStrip && goodOverNoiseAmpCol && hitOnMetal && twoStripsReco,1.0,5); // "TwoStripsReco");
        ...
        my_efficiencies["event_Gap"]->FillWeighted(pass && maxAmpNotEdgeStrip && goodOverNoiseAmpCol && !hitOnMetal && twoStripsReco,1.0,5); // "TwoStripsReco");
        ...
        my_efficiencies["event_MidGap"]->FillWeighted(pass && maxAmpNotEdgeStrip && goodOverNoiseAmpCol && hitOnMidGap && twoStripsReco,1.0,5); // "TwoStripsReco");
    } //event loop
}
