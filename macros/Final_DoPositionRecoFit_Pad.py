...
for l in range(len(AmpRatio_list)) : 
    ...
    # AmpRatio_profile.GetXaxis().SetTitle("% of signal in the upper left pad over both upper pads")
    AmpRatio_profile.GetXaxis().SetTitle("Percentage (%) of signal")
    # AmpRatio_profile.GetYaxis().SetTitle("Position relative to sensor center [mm]")
    AmpRatio_profile.GetYaxis().SetTitle("Relative X position [mm]")
