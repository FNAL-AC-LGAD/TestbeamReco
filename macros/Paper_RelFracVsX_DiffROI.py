...
outputfile = TFile(outdir+"RelFracVsX_DiffROI_"+histName+histCut+".root","RECREATE")
...
for i,ROI in enumerate(ROI_list):
    th1_relFrac = list_input[0].Get(histName+"_vs_x_channel03"+histCut+ROI).ProfileX()
...
TopRightText.DrawLatexNDC(1-myStyle.GetMargin()-0.005,1-myStyle.GetMargin()+0.01,"#bf{Diff ROI}")

canvas.SaveAs(outdir+"RelFracVsX_DiffROI_"+histName+histCut+".gif")
canvas.SaveAs(outdir+"RelFracVsX_DiffROI_"+histName+histCut+".pdf")
outputfile.Close()
