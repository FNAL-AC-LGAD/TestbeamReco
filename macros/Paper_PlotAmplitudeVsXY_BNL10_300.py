...
for channel in range(0, len(list_amplitude_vs_xy)):
    ...
    canvas.SaveAs(outdir+name+"Amplitude_EIC1cm_300um_v2.gif")
    canvas.SaveAs(outdir+name+"Amplitude_EIC1cm_300um_v2.pdf")
