...
for l in range(len(projection)) : 
    ...
    totalAmplitude_vs_x=TH1F("htemp","",1,2.0, 4.0)
    ...
    if l==0 : 
        canvas.SaveAs(outdir+"TotalAmplitude_vs_x.gif")
        canvas.SaveAs(outdir+"TotalAmplitude_vs_x.pdf")
    else :
        canvas.SaveAs(outdir+"TotalAmplitude_vs_y.gif")
        canvas.SaveAs(outdir+"TotalAmplitude_vs_y.pdf")
