...
all_histoInfos = [
    HistoInfo("deltaX_vs_Xtrack",   inputfile, "track", True,  35.0, "", "Track x position [mm]","Mean #Deltax [#mum]",sensor),
    HistoInfo("deltaX_vs_Xreco",    inputfile, "reco",  True,  35.0, "", "Reconstructed x position [mm]","Mean #Deltax [#mum]",sensor),
]
...
for info in all_histoInfos:
    ...
    canvas.SaveAs("PositionRes_vs_x_"+info.outHistoName+"_Mean.gif")
    canvas.SaveAs("PositionRes_vs_x_"+info.outHistoName+"_Mean.pdf")
    info.th1.Write()
    htemp.Delete()
