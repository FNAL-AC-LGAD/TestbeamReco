...
parser.add_option('-Z','--zmax', dest='zmax', default = 100.0, help="Set max Amp value in final plot")
...
list_htitles = [
    ...
    ["ampMax_vs_xy_Metal", "AmplitudePos_Metal", "Counts"],
    ["ampMaxNoSum_vs_xy_Metal", "AmplitudePosNoSum_Metal", "Counts"],
]
...
# Define output file
output_path = "%sAmplitudePosVsXY"%(outdir)
if (is_tight):
    output_path+= "_tight"
output_path+= ".root"
...
for i,info_entry in enumerate(all_histoInfos):
    print(info_entry.outHistoName, " = ", info_entry.th2.GetEntries(), "\n")
    hist = info_entry.th2
    hist.Draw("colz")
    hist.Write()
