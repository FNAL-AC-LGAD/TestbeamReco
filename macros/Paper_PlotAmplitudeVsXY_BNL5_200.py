...
for channel in range(0, len(list_amplitude_vs_xy)):
    ...
    canvas.SaveAs(outdir+name+"Amplitude_EIC0p5cm_200um.gif")
    canvas.SaveAs(outdir+name+"Amplitude_EIC0p5cm_200um.pdf")
