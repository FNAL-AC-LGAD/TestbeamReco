...
for channel in range(0, len(list_amplitude_vs_xy)):
    ...
    list_amplitude_vs_xy[channel].GetZaxis().SetTitle("Maximum amplitude [mV]")
    ...
    canvas.SaveAs(outdir+name+"Amplitude_EIC2p5cm_200um.gif")
    canvas.SaveAs(outdir+name+"Amplitude_EIC2p5cm_200um.pdf")
