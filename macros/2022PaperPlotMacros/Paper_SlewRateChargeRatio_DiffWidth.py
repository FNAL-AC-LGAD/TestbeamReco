...
hdummy.GetYaxis().SetTitle("Slew rate to charge ratio [mV ns^{-1} fC^{-1}]")
hdummy.SetMaximum(20.0)
...
canvas.SaveAs(outdir+"SlewRateChargeRatio_DiffWidth.gif")
canvas.SaveAs(outdir+"SlewRateChargeRatio_DiffWidth.pdf")
