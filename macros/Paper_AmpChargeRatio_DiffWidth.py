...
sensor_list = ["EIC_W2_1cm_500up_100uw_220V", "EIC_W1_1cm_500up_200uw_255V", "EIC_W2_1cm_500up_300uw_240V"]
list_input = []
...
stripindexFirst = ["01hot","01cold","01gap","01"];
stripindexSecond = ["01hot","01cold","01gap","01"];
stripindexThird = ["01hot","01cold","01gap","01"];
...
for nSensor,item1 in enumerate(sensor_list):
    ...
    for nstrip,item2 in enumerate(stripindexFirst):
        ...
        TH1DVar.append(list_input[nSensor].Get("ampChargeRatio%s"%(stripindex[nstrip])))
...
hdummy = ROOT.TH1D("","",1,80,320)
hdummy.GetXaxis().SetTitle("Metal width [#mum]")
hdummy.GetYaxis().SetTitle("Amplitude to charge ratio [mV fC^{-1}]")
hdummy.SetMaximum(10.0)
...
canvas.SaveAs(outdir+"AmpChargeRatio_DiffWidth.gif")
canvas.SaveAs(outdir+"AmpChargeRatio_DiffWidth.pdf")
