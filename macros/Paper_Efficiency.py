...
legend.AddEntry(efficiency_vs_x_project_fullReco_global, "Binary readout")
legend.AddEntry(hist_Global_TwoStrips, "Multi-channel reconstruction")
legend.AddEntry(hist_Global_OneStrip, "Only binary readout")
legend.Draw()
htemp.Draw("AXIS same")
