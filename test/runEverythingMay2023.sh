...
cd ../macros
#python DoPositionRecoFit.py  -D HPK_KOJI_50T_1P0_80P_60M_E240_190V -A --xmax 0.65 --fitOrder 5
#python DoPositionRecoFit.py  -D HPK_KOJI_20T_1P0_80P_60M_E240_112V -A --xmax 0.65 --fitOrder 5

cd ../test
#./MyAnalysis -A Align -D HPK_KOJI_50T_1P0_80P_60M_E240_190V -E 2000000 
#./MyAnalysis -A Align -D HPK_KOJI_20T_1P0_80P_60M_E240_112V -E 2000000 

cd ../macros
#python plot1DResFullScan.py  -D HPK_KOJI_50T_1P0_80P_60M_E240_190V
#python plot1DResFullScan.py  -D HPK_KOJI_20T_1P0_80P_60M_E240_112V

python PlotTimeDiffVsX.py -D HPK_KOJI_50T_1P0_80P_60M_E240_190V
python PlotTimeDiffVsX.py -D HPK_KOJI_20T_1P0_80P_60M_E240_112V

python Paper_XRes.py -D HPK_KOJI_50T_1P0_80P_60M_E240_190V
python Paper_XRes.py -D HPK_KOJI_20T_1P0_80P_60M_E240_112V
